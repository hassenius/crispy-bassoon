...
*/}}
{{- define "cloudng-ecs.slave.readinessProbe" -}}
...
*/}}
{{- define "cloudng-ecs.slave.livenessProbe" -}}
...
*/}}
{{- define "cloudng-ecs.slave.securityContext" -}}
...
*/}}
{{- define "cloudng-ecs.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "cloudng-ecs.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
